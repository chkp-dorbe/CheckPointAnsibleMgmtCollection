...
DOCUMENTATION = """
---
module: cp_mgmt_def_setting_facts
short_description: Get def-setting objects facts on Checkpoint over Web Services API
description:
  - Get def-setting objects facts on Checkpoint devices.
...
options:
  ...
  show_custom:
    description:
      - If true, only custom def-settings are shown. If false, only predefined def-settings are shown. When omitted, all def-settings are shown.
    type: bool
  filter:
    description:
...
EXAMPLES = """
- name: show-def-setting
  cp_mgmt_def_setting_facts:
    name: New Def Setting 1

- name: show-def-settings
  cp_mgmt_def_setting_facts:
"""
...
def main():
    ...
    api_call_object_plural_version = "def-settings"
