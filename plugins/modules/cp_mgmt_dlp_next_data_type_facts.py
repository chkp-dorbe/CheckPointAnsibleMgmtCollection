...
DOCUMENTATION = """
---
module: cp_mgmt_dlp_next_data_type_facts
short_description: Get dlp-next-data-type objects facts on Checkpoint over Web Services API
description:
  - Get dlp-next-data-type objects facts on Checkpoint devices.
...
EXAMPLES = """
- name: show-dlp-next-data-type
  cp_mgmt_dlp_next_data_type_facts:
    name: ASIC or FPGA Designs

- name: show-dlp-next-data-types
  cp_mgmt_dlp_next_data_type_facts:
    limit: 1
    offset: 1
"""
...
def main():
    ...
    api_call_object_plural_version = "dlp-next-data-types"
