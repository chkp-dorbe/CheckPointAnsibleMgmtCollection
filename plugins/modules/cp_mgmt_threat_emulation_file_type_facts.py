...
DOCUMENTATION = """
---
module: cp_mgmt_threat_emulation_file_type_facts
short_description: Get threat-emulation-file-type objects facts on Checkpoint over Web Services API
description:
  - Get threat-emulation-file-type objects facts on Checkpoint devices.
...
EXAMPLES = """
- name: show-threat-emulation-file-type
  cp_mgmt_threat_emulation_file_type_facts:
    file_type: pdf

- name: show-threat-emulation-file-types
  cp_mgmt_threat_emulation_file_type_facts:
    limit: 50
    offset: 0
"""
...
def main():
    ...
    api_call_object = "threat-emulation-file-type"
    api_call_object_plural_version = "threat-emulation-file-types"
