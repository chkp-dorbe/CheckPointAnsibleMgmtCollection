...
DOCUMENTATION = """
---
module: cp_mgmt_threat_emulation_image_facts
short_description: Get threat-emulation-image objects facts on Checkpoint over Web Services API
description:
  - Get threat-emulation-image objects facts on Checkpoint devices.
...
EXAMPLES = """
- name: show-threat-emulation-image
  cp_mgmt_threat_emulation_image_facts:
    name: Win10_64b

- name: show-threat-emulation-images
  cp_mgmt_threat_emulation_image_facts:
    limit: 50
    offset: 0
"""
...
def main():
    ...
    api_call_object = "threat-emulation-image"
    api_call_object_plural_version = "threat-emulation-images"
