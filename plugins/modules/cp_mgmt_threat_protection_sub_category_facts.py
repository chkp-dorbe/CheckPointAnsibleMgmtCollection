...
DOCUMENTATION = """
---
module: cp_mgmt_threat_protection_sub_category_facts
short_description: Get threat-protection-sub-category objects facts on Checkpoint over Web Services API
description:
  - Get threat-protection-sub-category objects facts on Checkpoint devices.
...
options:
  ...
  category:
    description:
      - Parent category id or name. When using name, 'blade' is also required. Note, For IPS category use 'threat-protection'.
    type: str
  blade:
    description:
      - The blade this category belongs to. Required when using category by name.
    type: str
  filter:
    description:
...
EXAMPLES = """
- name: show-threat-protection-sub-category
  cp_mgmt_threat_protection_sub_category_facts:
    name: Backdoor.WIN32.FoggyWeb.B

- name: show-threat-protection-sub-categories
  cp_mgmt_threat_protection_sub_category_facts:
    category: '5'
"""
...
def main():
    ...
    api_call_object = "threat-protection-sub-category"
    api_call_object_plural_version = "threat-protection-sub-categories"
