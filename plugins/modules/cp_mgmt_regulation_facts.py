...
DOCUMENTATION = """
---
module: cp_mgmt_regulation_facts
short_description: Get regulation objects facts on Checkpoint over Web Services API
description:
  - Get regulation objects facts on Checkpoint devices.
...
options:
  ...
  filter_by:
    description:
      - Filter the regulations based on the selected filters.
    type: dict
    suboptions:
      enabled_only:
        description:
          - Shows only the enabled regulations.
        type: bool
      user_defined_only:
        description:
...
EXAMPLES = """
- name: show-regulation
  cp_mgmt_regulation_facts:
    name: MyReg
...
def main():
    argument_spec = dict(
        ...
        name=dict(type='str'),
        show_requirements=dict(type='bool'),
        details_level=dict(type='str', choices=['uid', 'standard', 'full']),
        filter=dict(type='str'),
        filter_by=dict(type='dict', options=dict(
            enabled_only=dict(type='bool'),
    ...
    api_call_object = "regulation"
    api_call_object_plural_version = "regulations"
