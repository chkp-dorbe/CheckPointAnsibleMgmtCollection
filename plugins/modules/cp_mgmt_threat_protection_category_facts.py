...
DOCUMENTATION = """
---
module: cp_mgmt_threat_protection_category_facts
short_description: Get threat-protection-category objects facts on Checkpoint over Web Services API
description:
  - Get threat-protection-category objects facts on Checkpoint devices.
...
EXAMPLES = """
- name: show-threat-protection-category
  cp_mgmt_threat_protection_category_facts:
    blade: anti-bot
    name: Reputation IPs

- name: show-threat-protection-categories
  cp_mgmt_threat_protection_category_facts:
"""
...
def main():
    ...
    api_call_object = "threat-protection-category"
    api_call_object_plural_version = "threat-protection-categories"
