...
DOCUMENTATION = """
---
module: cp_mgmt_requirement_facts
short_description: Get requirement objects facts on Checkpoint over Web Services API
description:
  - Get requirement objects facts on Checkpoint devices.
...
options:
  ...
  filter_by:
    description:
      - Filter the requirements based on the selected filters.
    type: dict
    suboptions:
      regulation:
        description:
          - Regulation name or uid. Shows only requirements that are part of this regulation.
        type: list
        elements: str
      user_defined_only:
        description:
          - Shows only the user-defined regulations.
        type: bool
  limit:
    description:
...
def main():
    argument_spec = dict(
        ...
        filter_by=dict(type='dict', options=dict(
            regulation=dict(type='list', elements='str'),
    ...
    api_call_object_plural_version = "requirements"
